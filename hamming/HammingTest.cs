...
namespace exercism.hamming
{
    ...
    public class HammingTest
    {
        ...
        [Test]
        public void DifferentLengths_IncreaseHammingDistance()
        {
            Assert.That(Hamming.Compute("ACC", "ACCTAG"), Is.EqualTo(3));
        }

        [Test]
        public void DifferentLengths_IncreaseHammingDistance_WhenFirstIsBigger()
        {
            Assert.That(Hamming.Compute("ACCTAG", "ACC"), Is.EqualTo(3));
        }

        [Test]
        public void DifferentLengths_AndDifferent_BasePairs()
        {
            Assert.That(Hamming.Compute("ACCTAG", "TAG"), Is.EqualTo(6));
        }
    }
}