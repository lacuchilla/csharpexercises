...
namespace exercism
{
    ...
    public class WordCountTest
    {
        ...
        public void With_apostrophes()
        {
           ...
           // var wordCount = Phrase.WordCount("First: don't laugh. Then: don't cry.");
        ...
        [Test]
        public void Smaller_free_standing_apostrophe_test()
        {
            var counts = new Dictionary<string, int>
            {
                { "go", 1 },
            };
            Assert.That(Phrase.WordCount("go ' "), Is.EqualTo(counts));
        }
        ...
        public void With_apostrophes_as_quotes()
        {
            ...
            var wordCount = Phrase.WordCount("She said, 'let's meet at twelve o'clock'");
            Assert.That(wordCount, Is.EqualTo(counts));
        }
